# Hackberry-Pi_Zero
A handheld Linux terminal using Raspberry Pi Zero 2W (or Radxa Cubie A7Z) as Core with 3.5" 320×480 ST7798 TFT touchscreen and the original BlackBerry Keyboard
...
The main reason why I design and built this handheld cyberdeck is to treat this as a learning tool and also a funny toy for the hackers. It is powered by a raspberry pi zero 2w and a 3.5" 320×480 ST7798 TFT touchscreen. 
...
**Display**: 3.5" 320×480 ST7798 TFT touchscreen (SPI interface, XPT2046 resistive touch controller).  
